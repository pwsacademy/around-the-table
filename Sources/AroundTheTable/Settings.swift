...
enum Settings {
    ...
    static let cloudObjectStorage = (
        ...
        apiKey: settings["ATT:COS:API_KEY"] as? String,
        
        /// The complete URL of the bucket where the images should be stored.
        bucketURL: settings["ATT:COS:BUCKET_URL"] as? String
    )
    ...
    static let database = (
        ...
        uri: settings["ATT:DATABASE:URI"] as! String,
        
        /// The name of the database.
        name: settings["ATT:DATABASE:NAME"] as! String
    )
     ...
     */
    static let defaultCoordinates = (
        latitude: settings["ATT:DEFAULT_COORDINATES:LATITUDE"] as! Double,
        longitude: settings["ATT:DEFAULT_COORDINATES:LONGITUDE"] as! Double
    )
    ...
    static let facebook = (
        ...
        /// The Facebook app ID.
        app: settings["ATT:FACEBOOK:APP"] as! String,
